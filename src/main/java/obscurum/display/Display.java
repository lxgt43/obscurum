...
public final class Display {
  ...
  // specific colours
  public static final Color BG_WINDOW_FRAME = new Color(22, 22, 11);
  public static final Color FG_WINDOW_FRAME = new Color(82, 6, 4);
  public static final Color[] QUALITY_COLOURS = {new Color(255, 255, 255, 255),
      new Color(30, 255, 30, 0), new Color(0, 112, 255, 221),
      new Color(163, 53, 238, 0)};
  ...
  public static final Color[] COLOURS = {BLACK, RED, GREEN, YELLOW, ORANGE,
      BLUE, MAGENTA, CYAN, WHITE, BROWN, BRIGHT_BLACK, BRIGHT_RED, BRIGHT_GREEN,
