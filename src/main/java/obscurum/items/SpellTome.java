...
public class SpellTome extends ConsumableItem {
  ...
  private static DisplayTile[][] standardDisplay = {
    ...
    {new DisplayTile(DisplayCharacter.of(' ')), new DisplayTile(DisplayCharacter.of('/'), DisplayColour.BROWN),
     ...
     new DisplayTile(DisplayCharacter.of('\\')),
     new DisplayTile(DisplayCharacter.of('\\'), DisplayColour.BROWN), new DisplayTile(DisplayCharacter.of(' '))},
    {new DisplayTile(DisplayCharacter.of('='), DisplayColour.BROWN), new DisplayTile(DisplayCharacter.of('='), DisplayColour.BROWN),
     new DisplayTile(DisplayCharacter.of('='), DisplayColour.BROWN), new DisplayTile(DisplayCharacter.of('='), DisplayColour.BROWN),
     new DisplayTile(DisplayCharacter.of('='), DisplayColour.BROWN), new DisplayTile(DisplayCharacter.of('='), DisplayColour.BROWN),
     new DisplayTile(DisplayCharacter.of('='), DisplayColour.BROWN), new DisplayTile(DisplayCharacter.of('='), DisplayColour.BROWN),
     new DisplayTile(DisplayCharacter.of('='), DisplayColour.BROWN), new DisplayTile(DisplayCharacter.of('='), DisplayColour.BROWN),
    ...
    {new DisplayTile(DisplayCharacter.of(' ')), new DisplayTile(DisplayCharacter.of(' ')), new DisplayTile(DisplayCharacter.of(' ')),
     ...
     new DisplayTile(DisplayCharacter.of(' ')), new DisplayTile(DisplayCharacter.of(' ')), new DisplayTile(DisplayCharacter.of(' ')),
     new DisplayTile(DisplayCharacter.of(' ')), new DisplayTile(DisplayCharacter.of(' ')),
     new DisplayTile(DisplayCharacter.of('\''), DisplayColour.BROWN), new DisplayTile(DisplayCharacter.of('_'), DisplayColour.BROWN),
     new DisplayTile(DisplayCharacter.of('_'), DisplayColour.BROWN), new DisplayTile(DisplayCharacter.of('_'), DisplayColour.BROWN),
     new DisplayTile(DisplayCharacter.of('\''), DisplayColour.BROWN), new DisplayTile(DisplayCharacter.of(' ')),
     new DisplayTile(DisplayCharacter.of(' ')), new DisplayTile(DisplayCharacter.of(' ')), new DisplayTile(DisplayCharacter.of(' ')),
     new DisplayTile(DisplayCharacter.of(' ')), new DisplayTile(DisplayCharacter.of(' ')), new DisplayTile(DisplayCharacter.of(' ')),
     new DisplayTile(DisplayCharacter.of(' ')), new DisplayTile(DisplayCharacter.of(' ')), new DisplayTile(DisplayCharacter.of(' ')),
